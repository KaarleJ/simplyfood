...
const recipes = [
  {
    ...
    "duration": 120,
    "imgUrl": "https://firebasestorage.googleapis.com/v0/b/simplyfoodfiles.appspot.com/o/images%2Fspringrolls.jpg?alt=media&token=9119ad6e-4e36-4028-9d8e-c324482503fd",
    "description": "Small recipe to create crispy spring rolls in my mothers style",
    "guide": "Mince the garlic. Grate or chop the carrots into really small pieces. Heat the kettle and add oil. Add the garlic and carrot to the kettle. Sweat the vegetables. Add the minced meat and sear it. Add soy sauce and cook the mix in low heat for 10-20 min. Let the mix cool down a bit. Lay the rice paper on a flat surface. Place a spoonful of the mix on to the paper and start folding. Once you are done with folding. Heat the pan and add oil to it. Fry the folded rolls until golden brown. After frying let them cool down a bit and enjoy!"
  },
  {
    "id": 2,
  ...
  },
  {
    ...
    "duration": 30,
    "imgUrl": "https://firebasestorage.googleapis.com/v0/b/simplyfoodfiles.appspot.com/o/images%2Fchocolatecookies.jpg?alt=media&token=a378fc67-4697-463d-a125-a83fc23055c1",
